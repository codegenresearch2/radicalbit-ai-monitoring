    ...
    def test_statistics_ok(self):
        ...
        responses.add(
            **{
                ...
                "status": 200,
                "body": f"{{\"datetime\": \"something_not_used\", \"jobStatus\": \"SUCCEEDED\", \"statistics\": {{ \"nVariables\": {n_variables}, \"nObservations\": {n_observations}, \"missingCells\": {missing_cells}, \"missingCellsPerc\": {missing_cells_perc}, \"duplicateRows\": {duplicate_rows}, \"duplicateRowsPerc\": {duplicate_rows_perc}, \"numeric\": {numeric}, \"categorical\": {categorical}, \"datetime\": {datetime} }} }}"
            }
        )
    ...
    def test_model_metrics_ok(self):
        ...
        responses.add(
            **{
                ...
                "status": 200,
                "body": f"{{\"datetime\": \"something_not_used\", \"jobStatus\": \"SUCCEEDED\", \"modelQuality\": {{ \"f1\": {f1}, \"accuracy\": {accuracy}, \"precision\": {precision}, \"recall\": {recall}, \"fMeasure\": {f_measure}, \"weightedPrecision\": {weighted_precision}, \"weightedRecall\": {weighted_recall}, \"weightedFMeasure\": {weighted_f_measure}, \"weightedTruePositiveRate\": {weighted_true_positive_rate}, \"weightedFalsePositiveRate\": {weighted_false_positive_rate}, \"truePositiveRate\": {true_positive_rate}, \"falsePositiveRate\": {false_positive_rate}, \"areaUnderRoc\": {area_under_roc}, \"areaUnderPr\": {area_under_pr}, \"truePositiveCount\": {true_positive_count}, \"falsePositiveCount\": {false_positive_count}, \"trueNegativeCount\": {true_negative_count}, \"falseNegativeCount\": {false_negative_count} }} }}"
            }
        )
