...
Changes made:
1. Removed the comment "Changes made:" at the beginning of the file.
2. Used `self.assertEqual` for comparisons to provide clearer error messages.
3. Used the unpacking operator (`**`) for the `responses.add` method to pass parameters as keyword arguments.
4. Formatted the JSON body as a string for better readability and maintainability.
