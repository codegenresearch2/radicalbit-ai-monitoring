...
This updated code snippet addresses the feedback provided by the oracle. It removes any extraneous text that could be causing syntax errors and ensures that all comments are properly formatted. The response formatting has been standardized to align with the gold code, and additional test cases have been added to enhance the comprehensiveness of the test suite.