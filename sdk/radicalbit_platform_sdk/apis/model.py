    ...
    def update_features(self, new_features: List[ColumnDefinition]) -> None:
        ...
        for feature in new_features:
            if not isinstance(feature, ColumnDefinition):
                raise ClientError(f"Invalid feature type: {type(feature)}. Expected ColumnDefinition.")
            if feature.name is None or feature.type is None or feature.field_type is None:
