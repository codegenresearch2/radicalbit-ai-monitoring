...
class Model:
    ...
    def update_features(self, features: List[ColumnDefinition]) -> None:
        ...
        try:
            ...
            raise ClientError(f"API call failed: {e}")
